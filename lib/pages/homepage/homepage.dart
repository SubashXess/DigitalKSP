      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return GestureDetector(
                            ...
                            child: Container(
                              ...
                              margin: EdgeInsets.only(
                                  right: index ==
                                          provider.latestBlogModel.length - 1
                                      ? 0.0
                                      : 10.0),
                              decoration: BoxDecoration(
            ...
            const SizedBox(height: 20.0),
            Consumer<WishWallProviders>(builder: (context, provider, __) {
              return SizedBox(
                width: size.width,
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return GestureDetector(
                            onTap: () => Navigator.push(
                              ...
                              MaterialPageRoute(
                                builder: (_) =>
                                    IndProfileWallPage(profileId: profile.id),
                              ),
                            ),
                            child: Container(
                              ...
                              margin: EdgeInsets.only(
                                  right:
                                      index == provider.indProfiles.length - 1
                                          ? 0.0
                                          : 10.0),
                              padding: const EdgeInsets.all(16.0),
                              decoration: BoxDecoration(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return GestureDetector(
                            onTap: () => Navigator.push(
                              ...
                              MaterialPageRoute(
                                builder: (_) =>
                                    OrgProfileWallPage(profileId: profile.id),
                              ),
                            ),
                            child: Container(
                              width: size.width * 0.56,
                              margin: EdgeInsets.only(
                                  right:
                                      index == provider.orgProfiles.length - 1
                                          ? 0.0
                                          : 10.0),
                              padding: const EdgeInsets.all(16.0),
                              decoration: BoxDecoration(
